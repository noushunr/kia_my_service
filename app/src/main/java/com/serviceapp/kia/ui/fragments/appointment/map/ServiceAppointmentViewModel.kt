...
class ServiceAppointmentViewModel(
    ...
    private val mutableServiceCenter = MutableLiveData<MutableList<ServiceCenterDataResponse>>()

    val liveServiceCenter : LiveData<MutableList<ServiceCenterDataResponse>>
